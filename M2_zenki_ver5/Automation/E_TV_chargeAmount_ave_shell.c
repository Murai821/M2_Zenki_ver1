...
int main()
{
    ...
    char inputFilePath[] = "drone_datafile/txtfile/TV_chargeAmount.txt";                   // 読み込むファイルのパス
    char outputFilePath[] = "drone_datafile/txtfile/excel_data/Shell_TV_chargeAmount.txt"; // 書き込むファイルのパス
