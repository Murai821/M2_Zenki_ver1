#r, Nm に対する道路網をランダム生成し、巡回セールスマン問題を解くプログラム
import numpy as np
...
# 円内の点を生成
angles = np.random.uniform(0, 2 * np.pi, num_points_inner - 1)
...
radii_outer = np.random.uniform(d_limit, L/2, num_points_outer)
...
""""作成した道路ネットワークにおいて巡回セールスマン問題を解くプログラム"""
