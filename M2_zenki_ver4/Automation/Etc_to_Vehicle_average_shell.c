...
int main()
{
    ...
    char inputFilePath[] = "drone_datafile/txtfile/Mean_ETC_to_Vehicle.txt";                      // 読み込むファイルのパス
    char outputFilePath[] = "drone_datafile/txtfile/excel_data/Shell_Etc_to_Vehicle_average.txt"; // 書き込むファイルのパス
    ...
    printf("E(TC) to Vehicle: %.6f をファイルに書き込みました。\n", average);
